...
export default class UI extends Phaser.Scene {
    ...
    create(){
        ...
        let waterText = this.add.bitmapText(Game_Config.UI_tilesToWorld(2), Game_Config.GAMEHEIGHT - Game_Config.UI_tilesToWorld(8), 'ant_party', 'Water: ' + Game_Config.WATER_START_LEVEL)
            .setOrigin(0,0)
            .setTint(0x0095e9)
