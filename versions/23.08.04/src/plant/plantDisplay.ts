...
export default class PlantDisplay {
    ...
    private plantTileData: number[][] =  [...Array(Game_Config.MAP_SIZE)].map(e => Array(Game_Config.MAP_SIZE).fill(-1));
    ...
    constructor(scene: Phaser.Scene, plantManager: PlantManager){
        ...
        this.plantTileMap = scene.make.tilemap({width: Game_Config.MAP_SIZE, height: Game_Config.MAP_SIZE, tileWidth: Game_Config.MAP_RES, tileHeight: Game_Config.MAP_RES});
